    ...
    private String doVerify(List<DataItem> dataItems, ImportEditor importEditor) throws Exception {
        ...
        for (DataItem dataItem : dataItems) {
            ...
            if (departureAirportEntity != null && arrivalAirportEntity != null) {
                ...
                Integer recomputedFlightDistance = FlightlogHelper.computeDistanceInKilometers(departureAirportEntity.getLongitude(), departureAirportEntity.getLatitude(), arrivalAirportEntity.getLongitude(), arrivalAirportEntity.getLatitude());
                ...
                if (departureTimeAvailable && arrivalTimeAvailable && dataItem.getFlightDuration() == null) {
                    dataItem.setFlightDuration(FlightlogHelper.computeDuration(departureAirportEntity.getTimezoneId(), dataItem.getDepartureDateLocal(), dataItem.getDepartureTimeLocal(), arrivalAirportEntity.getTimezoneId(), dataItem.getArrivalDateLocal(), dataItem.getArrivalTimeLocal()));

...
public class ExportController {
    ...
    public void doXml(@AuthenticationPrincipal FlightlogUser user, HttpServletResponse response) throws Exception {
    ...
    public void doJson(@AuthenticationPrincipal FlightlogUser user, HttpServletResponse response) throws Exception {
    ...
    public void doOpenflightsCsv(@AuthenticationPrincipal FlightlogUser user, HttpServletResponse response) throws Exception {
        this.doExport(user, new OpenflightsCsvDataWriter(), "text/csv", ".csv", response);
    }

    private void doExport(@AuthenticationPrincipal FlightlogUser user, DataWriter<String> dataWriter, String contentType, String fileExtension, HttpServletResponse response) throws Exception {

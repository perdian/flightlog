...
public class FlightEditor implements Serializable {
    ...
    public FlightEditor(FlightBean flight) {
        ...
        this.setArrivalDateLocal(flight.getArrivalContact() == null || flight.getArrivalContact().getDateLocal() == null ? null : FlightlogHelper.formatDate(flight.getArrivalContact().getDateLocal()));
        this.setArrivalTimeLocal(flight.getArrivalContact() == null || flight.getArrivalContact().getTimeLocal() == null ? null : FlightlogHelper.formatTime(flight.getArrivalContact().getTimeLocal()));
        ...
        this.setDepartureDateLocal(flight.getDepartureContact() == null || flight.getDepartureContact().getDateLocal() == null ? null : FlightlogHelper.formatDate(flight.getDepartureContact().getDateLocal()));
        this.setDepartureTimeLocal(flight.getDepartureContact() == null || flight.getDepartureContact().getTimeLocal() == null ? null : FlightlogHelper.formatTime(flight.getDepartureContact().getTimeLocal()));
    ...
    public void copyValuesInto(FlightBean flightBean) {
        ...
        arrivalAirportContactBean.setDateLocal(FlightlogHelper.parseLocalDate(this.getArrivalDateLocal()));
        arrivalAirportContactBean.setTimeLocal(FlightlogHelper.parseLocalTime(this.getArrivalTimeLocal()));
        ...
        departureAirportContactBean.setDateLocal(FlightlogHelper.parseLocalDate(this.getDepartureDateLocal()));
        departureAirportContactBean.setTimeLocal(FlightlogHelper.parseLocalTime(this.getDepartureTimeLocal()));

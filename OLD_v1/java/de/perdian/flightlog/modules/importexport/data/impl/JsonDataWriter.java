...
public class JsonDataWriter implements DataWriter<String> {
    ...
    public String writeDataItems(List<DataItem> dataItems) throws Exception {
        ...
        for (DataItem dataItem : dataItems) {
            ...
            Optional.ofNullable(dataItem.getArrivalDateLocal()).ifPresent(value -> flightNode.put("arrivalDateLocal", FlightlogHelper.formatDate(value)));
            Optional.ofNullable(dataItem.getArrivalTimeLocal()).ifPresent(value -> flightNode.put("arrivalTimeLocal", FlightlogHelper.formatTime(value)));
            ...
            Optional.ofNullable(dataItem.getDepartureDateLocal()).ifPresent(value -> flightNode.put("departureDateLocal", FlightlogHelper.formatDate(value)));
            Optional.ofNullable(dataItem.getDepartureTimeLocal()).ifPresent(value -> flightNode.put("departureTimeLocal", FlightlogHelper.formatTime(value)));
            Optional.ofNullable(dataItem.getFlightDistance()).ifPresent(value -> flightNode.put("flightDistance", String.valueOf(value)));
            Optional.ofNullable(dataItem.getFlightDuration()).ifPresent(value -> flightNode.put("flightDuration", FlightlogHelper.formatDuration(value)));

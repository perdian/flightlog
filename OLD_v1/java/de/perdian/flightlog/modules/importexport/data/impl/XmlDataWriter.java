...
public class XmlDataWriter implements DataWriter<String> {
    ...
    public String writeDataItems(List<DataItem> dataItems) throws Exception {
        ...
        for (DataItem dataItem : dataItems) {
            ...
            Optional.ofNullable(dataItem.getArrivalDateLocal()).ifPresent(value -> flightElement.addElement("arrivalDateLocal").setText(FlightlogHelper.formatDate(value)));
            Optional.ofNullable(dataItem.getArrivalTimeLocal()).ifPresent(value -> flightElement.addElement("arrivalTimeLocal").setText(FlightlogHelper.formatTime(value)));
            ...
            Optional.ofNullable(dataItem.getDepartureDateLocal()).ifPresent(value -> flightElement.addElement("departureDateLocal").setText(FlightlogHelper.formatDate(value)));
            Optional.ofNullable(dataItem.getDepartureTimeLocal()).ifPresent(value -> flightElement.addElement("departureTimeLocal").setText(FlightlogHelper.formatTime(value)));
            ...
            Optional.ofNullable(dataItem.getFlightDuration()).ifPresent(value -> flightElement.addElement("flightDuration").setText(FlightlogHelper.formatDuration(value)));

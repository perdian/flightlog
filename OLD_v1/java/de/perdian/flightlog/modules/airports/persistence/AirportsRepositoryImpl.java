...
class AirportsRepositoryImpl implements AirportsRepository {
    ...
    void initialize() throws IOException {
        ...
        Resource countriesResource = this.getResourceLoader().getResource("classpath:de/perdian/flightlog/data/countries.dat");
        ...
        Resource airportsResource = this.getResourceLoader().getResource("classpath:de/perdian/flightlog/data/airports-extended.dat");
